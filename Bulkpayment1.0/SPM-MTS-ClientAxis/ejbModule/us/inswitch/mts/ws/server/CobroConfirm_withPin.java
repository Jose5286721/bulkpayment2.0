 ...
 */
            ...
            /**
            *  CobroConfirm_withPin bean class
            */
        
        public  class CobroConfirm_withPin
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = cobroConfirm_withPin
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for Reintentos_pin
                        */

                        
                                    protected java.lang.String localReintentos_pin ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localReintentos_pinTracker = false ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getReintentos_pin(){
                               return localReintentos_pin;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Reintentos_pin
                               */
                               public void setReintentos_pin(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localReintentos_pinTracker = true;
                                       } else {
                                          localReintentos_pinTracker = false;
                                              
                                       }
                                   
                                            this.localReintentos_pin=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CobroConfirm_withPin.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":cobroConfirm_withPin",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"reintentos_pin", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"reintentos_pin");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("reintentos_pin");
                                    }
                                

                                          if (localReintentos_pin==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("reintentos_pin cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localReintentos_pin);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMonto));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localReintentos_pin != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReintentos_pin));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("reintentos_pin cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static CobroConfirm_withPin parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CobroConfirm_withPin object =
                new CobroConfirm_withPin();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cobroConfirm_withPin".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CobroConfirm_withPin)us.inswitch.mts.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","reintentos_pin").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setReintentos_pin(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
