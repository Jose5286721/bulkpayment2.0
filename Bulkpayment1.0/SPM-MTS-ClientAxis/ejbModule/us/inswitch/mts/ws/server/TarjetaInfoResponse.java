 ...
 */
            ...
            /**
            *  TarjetaInfoResponse bean class
            */
        
        public  class TarjetaInfoResponse extends us.inswitch.mts.ws.server.TrnResponsePack
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = tarjetaInfoResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for TarjetaInfo
                        */

                        
                                    protected us.inswitch.mts.ws.server.TarjetaInfo localTarjetaInfo ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTarjetaInfoTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return us.inswitch.mts.ws.server.TarjetaInfo
                           */
                           public  us.inswitch.mts.ws.server.TarjetaInfo getTarjetaInfo(){
                               return localTarjetaInfo;
                           }
                            ...
                            /**
                               ...
                               * @param param TarjetaInfo
                               */
                               public void setTarjetaInfo(us.inswitch.mts.ws.server.TarjetaInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localTarjetaInfoTracker = true;
                                       } else {
                                          localTarjetaInfoTracker = false;
                                              
                                       }
                                   
                                            this.localTarjetaInfo=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       TarjetaInfoResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":tarjetaInfoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "tarjetaInfoResponse",
                ...
                if (localMensajeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTarjetaInfoTracker){
                                            if (localTarjetaInfo==null){
                                                 throw new org.apache.axis2.databinding.ADBException("tarjetaInfo cannot be null!!");
                                            }
                                           localTarjetaInfo.serialize(new javax.xml.namespace.QName("","tarjetaInfo"),
                                               factory,xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://server.ws.mts.inswitch.us/","tarjetaInfoResponse"));
                 if (localMensajeTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localTarjetaInfo);
                                }
    ...
    public static class Factory{
        ...
        */
        public static TarjetaInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TarjetaInfoResponse object =
                new TarjetaInfoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tarjetaInfoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TarjetaInfoResponse)us.inswitch.mts.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","tarjetaInfo").equals(reader.getName())){
                                
                                                object.setTarjetaInfo(us.inswitch.mts.ws.server.TarjetaInfo.Factory.parse(reader));
