 ...
 * 
 */
public class SpmQueues {

	public static final String UPDATER_QUEUE="jms/spmUpdaterQueue";

	public static final String FLOW_MANAGER_QUEUE="jms/spmFlowManagerQueue";
	
	public static final String MTS_INTERFACE_QUEUE="jms/spmMtsInterfaceQueue";
	
	public static final String MTS_REVERSION_INTERFACE_QUEUE="jms/spmMtsReversionInterfaceQueue";
	...
	public static final String SMS_RECEIVED_QUEUE = "jms/spmSmsMessageReceivedQueue";
