...
public class SpmConstants {
	...
	public static final String OK_DSC="Operación Exitosa";

	public static final String ERROR_DSC="Operación Fallida";

	public static final String TIMEOUT="Ocurrió un Timeout";

	public static final String EMPTY_ENTITY="Entidad No encontrada";

	public static final String PAYMENT_ORDER_STATE_SIGN_ERROR="Estado inválido, debe estar con estado en Proceso";
