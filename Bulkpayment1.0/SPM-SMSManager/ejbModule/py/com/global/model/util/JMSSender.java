...
public class JMSSender {
	...
	public static final String JBOSS_CONNECTION_FACTORY = "jms/RemoteConnectionFactory";
	...
	public JMSSender(InitialContext initialContext, String connectionFactory,
		...
		try {
            ...
            logger.info("Found Queue, "+queue.getQueueName());
		} catch (Exception e) {
	...
	public boolean init() {
		...
		try {
			if (queueConnectionFactory != null && queue != null) {
				queueConnection = queueConnectionFactory.createQueueConnection(JMSSenderParameters.DEFAULT_USERNAME,
						JMSSenderParameters.DEFAULT_PASSWORD);
