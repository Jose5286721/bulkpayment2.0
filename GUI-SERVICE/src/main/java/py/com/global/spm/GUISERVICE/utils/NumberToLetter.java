...
public class NumberToLetter {
    ...
    public static String toLetter(String s) {
        ...
        if (triMiles > 0 && triMiles !=1)       result.append(triTexto(triMiles).toString() + "Mil ");
        else if(triMiles>0) result.append("Mil ");
    ...
    public static void  main(String[] args){
        System.out.println(NumberToLetter.toLetter("112354"));
    }
}
