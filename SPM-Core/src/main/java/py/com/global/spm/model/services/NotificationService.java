...
public class NotificationService {
    ...
    private void initialize() {
        ...
        String classpath = systemParameterService.getParameterValue(SpmProcesses.DRIVER_NOTIFICATIONS,
                DriversParameters.NOTIFICATIONMANAGER_DRIVERCLASSPATH.getDataBase());
        if (classpath == null) {
            log.error(
            ...
            synchronized (this) {
                ...
                ConcurrentHashMap<String, String> param = this.systemParameterService
                        .getParameters(SpmProcesses.DRIVER_NOTIFICATIONS);
                if (this.parameters == null
                    ...
                    if (driver == null) {
                        log.error("Driver Validar Agente no instanciado");
                    } else {
                        log.info("Cargando parametros en el driver, Process Id --> "
                                + SpmProcesses.DRIVER_NOTIFICATIONS);
